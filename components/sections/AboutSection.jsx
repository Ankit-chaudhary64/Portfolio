  ...
  return (
    <section ref={sectionRef} className={styles.section}>
      ...
      <div ref={contentRef} className={styles.content}>
        ...
        {/* Structured Skills Grid - fades in when typewriter animation is done */}
        {profile.skillsGrouped && (
          <div className={`${styles.skillsGrid} ${done ? styles.skillsGridActive : ''}`}>
            {Object.entries(profile.skillsGrouped).map(([category, list]) => (
